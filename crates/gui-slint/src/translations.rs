...
pub struct Strings {
    ...
    pub group_activity: &'static str,
    pub group_network: &'static str,
    ...
    pub backup_tab_auto: &'static str,
...
pub const EN: Strings = Strings {
    ...
    group_activity: "Recent activity",
